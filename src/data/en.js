export default {
	...
	summarySubtitle: "Engineering Leader Driving AI Transformation at Microsoft",
	summary: [
	...
	jobs: [
		{
			company: "Microsoft (ASG → WebXT → MAI)",
			title: "Principal Software Engineering Manager",
			meta: "2012 - Present · Beijing",
			items: [
		...
		{
			company: "Alibaba Group – UED Team",
			title: null,
			meta: "2010 - 2012",
			items: [
	...
	education: [
		{
			...
			degree: "M.Eng. in Computer Software and Theory (Distributed Systems)",
			year: "2010",
		},
		{
			school: "Tongji University",
	...
	patent: {
		id: "CN103248610 A",
		name: "Mobile search UI/UX innovation (2013)",
		url: "https://patents.google.com/patent/CN103248610A",
		linkText: "View Patent",
	},

	leadershipTitle: "Leadership & Communication",
	leadership: [
