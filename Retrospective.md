...
- Follow-up: isolate DOM snapshot collection in the performance suite while preserving screenshot recording, action/network traces, native timing attachments, failure screenshots and every original scenario, sample and threshold. Normal browser tests retain their full DOM traces. Hosted comparison and fresh CI/release acceptance remain required before claiming recovery.
