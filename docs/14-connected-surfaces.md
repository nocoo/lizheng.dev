...
The Portfolio header references also preserve each environment's arrow glyph rendering. CI updates use the runner's actual navigation region while retaining all existing pixels outside that region.
